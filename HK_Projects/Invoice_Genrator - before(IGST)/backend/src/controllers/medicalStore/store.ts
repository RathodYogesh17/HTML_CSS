...
export class StoreController {
  ...
  static async create(req: any, res: Response) {
    ...
    try {
      ...
      // Add createdBy information from authenticated user
      const storeData = {
        ...req.body,
  ...
  static async getAll(req: any, res: Response) {
    ...
    try {
      ...
      // If not admin, only show stores created by the user
  ...
  static async getById(req: any, res: Response) {
    ...
    try {
      ...
      // Check permission: Only admin or the creator can view the store
      if (req.user.role !== 'ADMIN' && store.createdBy?.toString() !== req.user.userId) {
        return errorResponse(
          res,
