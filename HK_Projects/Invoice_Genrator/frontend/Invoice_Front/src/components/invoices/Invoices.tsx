...
const MedicalInvoiceView = () => {
  ...
  const fetchInvoice = async () => {
    try {
      ...
      // The response structure from getInvoiceById
  ...
  return (
    <div style={{
      ...
      >
        ...
        {/* Patient and Pharmacist Details */}
                ...
                <Descriptions column={1} bordered={false} size="small">
                  ...
                  >
                    <Space>
                      ...
                      <Text>{invoice.customerMobile || "N/A"}</Text>
                    </Space>
                  </Descriptions.Item>
                  <Descriptions.Item 
                    label={<Text strong style={{ color: colors.text.primary }}>Prescription</Text>}
                  >
                    <Tag color={colors.accent} style={{ borderRadius: 16 }}>RX-{invoice.invoiceNumber}</Tag>
                  </Descriptions.Item>
                </Descriptions>
              </Card>
            </Col>
                ...
                <Descriptions column={1} bordered={false} size="small">
                  ...
                  >
                    <Space>
                      ...
                      <Text strong>{invoice.createdBy?.ownerName || "N/A"}</Text>
                    </Space>
                  </Descriptions.Item>
                  <Descriptions.Item 
                    label={<Text strong style={{ color: colors.text.primary }}>License No</Text>}
                  >
                    <Tag color={colors.accent} style={{ borderRadius: 16 }}>DL-MED-2024-001</Tag>
                  </Descriptions.Item>
                  <Descriptions.Item 
                  ...
                  >
                    <Space>
                      ...
                      <Text>{invoice.createdBy?.email || "N/A"}</Text>
                    </Space>
                  </Descriptions.Item>
                </Descriptions>
              </Card>
