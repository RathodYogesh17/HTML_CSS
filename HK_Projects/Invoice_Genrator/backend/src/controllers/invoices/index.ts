...
// controllers/invoice.controller.ts - Already correct
export const createInvoice = async (req: authRequest, res: Response) => {
  try {
    ...
    const invoice = await invoiceService.createInvoiceService(req.body, req.user);
    return successResponse(res, responseMessage.addDataSuccess("Invoice"), invoice, STATUS_CODE.CREATED);
  } catch (error: any) {
    return errorResponse(res, error.message || responseMessage.internalServerError, error.statusCode || STATUS_CODE.BAD_REQUEST);
  }
};
